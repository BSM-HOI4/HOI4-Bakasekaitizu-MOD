...
- Do not port other repositories' (Tsareich2, SSW_mod) mod-specific IDs, tags, lore, or systems unless the user explicitly asks; they are reference repos only (see AGENTS.md).
